...
UI_STRINGS = {
    'de': {
        ...
        'help_exempt_groups': 'Ein Gruppenname pro Zeile. Alle Mitglieder dieser Gruppen umgehen die Erzwingung vollst\u00e4ndig.',
        'label_webhook_enabled': 'Webhook aktivieren',
        'help_webhook_enabled': 'Sendet eine JSON-POST-Anfrage an die konfigurierte URL bei jedem Versto\u00df.',
        'label_webhook_url': 'Webhook-URL',
        'help_webhook_url': 'HTTP-POST-Endpunkt. Kompatibel mit Slack, Teams und eigenen APIs.',
        'label_webhook_secret': 'Webhook-Secret',
        'help_webhook_secret': 'Optionales HMAC-SHA256-Secret. Signatur wird als X-NetBox-Force-Signature-Header gesendet.',

        # Model Policies (v4.3.0)
        'policy_title': 'Model-Policies',
        'policy_add_title': 'Policy hinzuf\u00fcgen',
        'policy_edit_title': 'Policy bearbeiten',
        'policy_delete_title': 'Policy l\u00f6schen',
        'policy_delete_confirm': 'Soll diese Model-Policy wirklich gel\u00f6scht werden?',
        'policy_delete_effect': 'Nach dem L\u00f6schen verwendet dieses Modell wieder die globalen Einstellungen.',
        'policy_empty': 'Keine Model-Policies definiert. Alle Modelle verwenden die globalen Einstellungen.',
        'policy_col_model': 'Modell',
        'policy_col_enforcement': 'Erzwingung',
        'policy_col_min_length': 'Min. L\u00e4nge',
        'policy_col_ticket': 'Ticket',
        'policy_col_change_window': '\u00c4nderungsfenster',
        'policy_col_checks': 'Pr\u00fcfungen',
        'policy_col_notes': 'Notizen',
        'policy_col_naming': 'Namenskonvention',
        'policy_col_required': 'Pflichtfelder',
        'policy_use_global': 'global',
        'policy_required': 'Pflicht',
        'policy_skipped': '\u00dcbersprungen',
        'policy_enforced': 'Aktiv',
        'policy_section_model': 'Zielmodell',
        'policy_section_enforcement': 'Erzwingung',
        'policy_section_overrides': 'Feature-Overrides',
        'policy_help_model': 'W\u00e4hle das Modell, f\u00fcr das diese Policy gilt. Format: app.model (z.B. dcim.device).',
        'policy_help_notes': 'Optionale Beschreibung, warum diese Policy existiert.',
        'policy_enforcement_enabled': 'Erzwingung aktiviert',
        'policy_help_enforcement': 'Wenn deaktiviert, werden alle Enforcement-Pr\u00fcfungen f\u00fcr dieses Modell \u00fcbersprungen.',
        'policy_help_min_length': '\u00dcberschreibt die globale Mindestl\u00e4nge f\u00fcr dieses Modell. Leer lassen f\u00fcr globale Einstellung.',
        'policy_help_ticket': 'Ticket-Pflicht f\u00fcr dieses Modell \u00fcberschreiben. "Unbekannt" = globale Einstellung verwenden.',
        'policy_help_change_window': '\u00c4nderungsfenster f\u00fcr dieses Modell \u00fcberschreiben. "Unbekannt" = globale Einstellung.',
        'policy_check_naming': 'Namenskonvention-Regeln pr\u00fcfen',
        'policy_help_naming': 'Wenn deaktiviert, werden Namenskonvention-Regeln f\u00fcr dieses Modell nicht angewendet.',
        'policy_check_required': 'Pflichtfeld-Regeln pr\u00fcfen',
        'policy_help_required': 'Wenn deaktiviert, werden Pflichtfeld-Regeln f\u00fcr dieses Modell nicht angewendet.',
        'policy_info_text': 'Model-Policies erm\u00f6glichen es, globale Enforcement-Einstellungen f\u00fcr bestimmte Modelle zu \u00fcberschreiben.',
        'policy_info_global': 'Felder auf "Unbekannt" oder leer lassen, um globale Einstellungen zu verwenden',
        'policy_info_disable': 'Erzwingung deaktivieren, um das Modell vollst\u00e4ndig auszunehmen',
        'policy_info_override': 'Overrides werden sofort wirksam',

        # Audit Scan (v4.3.0)
        'audit_scan_title': 'Audit-Scan',
        'audit_scan_description': 'Scannt bestehende Objekte in der Datenbank gegen aktive Validierungsregeln. Nur lesend \u2014 es werden keine \u00c4nderungen vorgenommen.',
        'audit_scan_models_with_rules': 'Modelle mit aktiven Regeln',
        'audit_scan_no_rules': 'Keine aktiven Validierungsregeln gefunden. Erstelle zuerst Regeln, um den Audit-Scan zu nutzen.',
        'audit_scan_run': 'Scan starten',
        'audit_scan_limit_hint': 'Der Scan ist auf 500 Objekte pro Modell begrenzt, um Timeouts zu vermeiden.',
        'audit_scan_results': 'Scan-Ergebnisse',
        'audit_scan_violations': 'Versto\u00df/Verst\u00f6\u00dfe',
        'audit_scan_errors': 'Scan-Fehler',
        'audit_scan_empty': 'Keine Verst\u00f6\u00dfe gefunden. Alle vorhandenen Objekte entsprechen den aktuellen Regeln.',
        'audit_scan_col_model': 'Modell',
        'audit_scan_col_object': 'Objekt',
        'audit_scan_col_type': 'Regeltyp',
        'audit_scan_col_message': 'Meldung',
    },
    ...
    'en': {
        ...
        'help_exempt_groups': 'One group name per line. All members of these groups bypass enforcement entirely.',
        'label_webhook_enabled': 'Enable webhook',
        'help_webhook_enabled': 'Send a JSON POST request to the configured URL on every violation.',
        'label_webhook_url': 'Webhook URL',
        'help_webhook_url': 'HTTP POST endpoint. Compatible with Slack, Teams, and custom APIs.',
        'label_webhook_secret': 'Webhook secret',
        'help_webhook_secret': 'Optional HMAC-SHA256 secret. Signature sent as X-NetBox-Force-Signature header.',
        ...
        'policy_delete_confirm': 'Are you sure you want to delete this model policy?',
        'policy_delete_effect': 'After deletion, this model will use global settings again.',
        'policy_empty': 'No model policies defined. All models use global settings.',
        'policy_col_model': 'Model',
        'policy_col_enforcement': 'Enforcement',
        'policy_col_min_length': 'Min Length',
        'policy_col_ticket': 'Ticket',
        'policy_col_change_window': 'Change Window',
        'policy_col_checks': 'Checks',
        'policy_col_notes': 'Notes',
        'policy_col_naming': 'Naming',
        'policy_col_required': 'Required Fields',
        'policy_use_global': 'global',
        'policy_required': 'Required',
        'policy_skipped': 'Skipped',
        'policy_enforced': 'Enforced',
        'policy_section_model': 'Target Model',
        'policy_section_enforcement': 'Enforcement',
        'policy_section_overrides': 'Feature Overrides',
        'policy_help_model': 'Select the model this policy applies to. Format: app.model (e.g. dcim.device).',
        'policy_help_notes': 'Optional description of why this policy exists.',
        'policy_enforcement_enabled': 'Enforcement enabled',
        'policy_help_enforcement': 'If disabled, all enforcement checks are skipped for this model.',
        'policy_help_min_length': 'Overrides the global minimum for this model. Leave empty to use the global setting.',
        'policy_help_ticket': 'Override ticket enforcement for this model. "Unknown" = use global setting.',
        'policy_help_change_window': 'Override change window enforcement for this model. "Unknown" = use global setting.',
        'policy_check_naming': 'Check naming convention rules',
        'policy_help_naming': 'If disabled, naming convention rules are not applied to this model.',
        'policy_check_required': 'Check required field rules',
        'policy_help_required': 'If disabled, required field rules are not applied to this model.',
        'policy_info_text': 'Model Policies allow you to override global enforcement settings for specific models.',
        'policy_info_global': 'Leave fields at "Unknown" or empty to inherit global settings',
        'policy_info_disable': 'Disable enforcement to fully exempt this model',
        'policy_info_override': 'Overrides take effect immediately',

        # Audit Scan (v4.3.0)
        'audit_scan_title': 'Audit Scan',
        'audit_scan_description': 'Scans existing objects in the database against active ValidationRules. Read-only \u2014 no changes are made.',
        'audit_scan_models_with_rules': 'Models with active rules',
        'audit_scan_no_rules': 'No active Validation Rules found. Create rules first to use the audit scan.',
        'audit_scan_run': 'Run Scan',
        'audit_scan_limit_hint': 'Scan is limited to 500 objects per model to avoid timeouts.',
        'audit_scan_results': 'Scan Results',
        'audit_scan_violations': 'violation(s)',
        'audit_scan_errors': 'Scan errors',
        'audit_scan_empty': 'No violations found. All existing objects comply with the current rules.',
        'audit_scan_col_model': 'Model',
        'audit_scan_col_object': 'Object',
        'audit_scan_col_type': 'Rule type',
        'audit_scan_col_message': 'Message',
    },
    ...
    'es': {
        ...
        'help_exempt_groups': 'Un nombre de grupo por l\u00ednea. Todos los miembros de estos grupos omiten la aplicaci\u00f3n por completo.',
        'label_webhook_enabled': 'Activar webhook',
        'help_webhook_enabled': 'Env\u00eda una solicitud JSON POST a la URL configurada en cada violaci\u00f3n.',
        'label_webhook_url': 'URL del webhook',
        'help_webhook_url': 'Endpoint HTTP POST. Compatible con Slack, Teams y APIs personalizadas.',
        'label_webhook_secret': 'Secreto del webhook',
        'help_webhook_secret': 'Secreto HMAC-SHA256 opcional. La firma se env\u00eda como cabecera X-NetBox-Force-Signature.',

        # Model Policies (v4.3.0)
        'policy_title': 'Pol\u00edticas de Modelo',
        'policy_add_title': 'A\u00f1adir Pol\u00edtica',
        'policy_edit_title': 'Editar Pol\u00edtica',
        'policy_delete_title': 'Eliminar Pol\u00edtica',
        'policy_delete_confirm': '\u00bfEst\u00e1s seguro de que quieres eliminar esta pol\u00edtica de modelo?',
        'policy_delete_effect': 'Tras la eliminaci\u00f3n, este modelo volver\u00e1 a usar la configuraci\u00f3n global.',
        'policy_empty': 'No hay pol\u00edticas de modelo definidas. Todos los modelos usan la configuraci\u00f3n global.',
        'policy_col_model': 'Modelo',
        'policy_col_enforcement': 'Aplicaci\u00f3n',
        'policy_col_min_length': 'Long. m\u00edn.',
        'policy_col_ticket': 'Ticket',
        'policy_col_change_window': 'Ventana de cambios',
        'policy_col_checks': 'Verificaciones',
        'policy_col_notes': 'Notas',
        'policy_col_naming': 'Nombres',
        'policy_col_required': 'Campos requeridos',
        'policy_use_global': 'global',
        'policy_required': 'Requerido',
        'policy_skipped': 'Omitido',
        'policy_enforced': 'Activo',
        'policy_section_model': 'Modelo objetivo',
        'policy_section_enforcement': 'Aplicaci\u00f3n',
        'policy_section_overrides': 'Anulaciones de funciones',
        'policy_help_model': 'Selecciona el modelo al que se aplica esta pol\u00edtica. Formato: app.model (p. ej. dcim.device).',
        'policy_help_notes': 'Descripci\u00f3n opcional de por qu\u00e9 existe esta pol\u00edtica.',
        'policy_enforcement_enabled': 'Aplicaci\u00f3n activada',
        'policy_help_enforcement': 'Si se desactiva, se omiten todas las verificaciones de aplicaci\u00f3n para este modelo.',
        'policy_help_min_length': 'Anula la longitud m\u00ednima global para este modelo. Dejar vac\u00edo para usar la configuraci\u00f3n global.',
        'policy_help_ticket': 'Anular la aplicaci\u00f3n de ticket para este modelo. "Desconocido" = usar configuraci\u00f3n global.',
        'policy_help_change_window': 'Anular la ventana de cambios para este modelo. "Desconocido" = usar configuraci\u00f3n global.',
        'policy_check_naming': 'Verificar reglas de convenci\u00f3n de nombres',
        'policy_help_naming': 'Si se desactiva, las reglas de convenci\u00f3n de nombres no se aplican a este modelo.',
        'policy_check_required': 'Verificar reglas de campos requeridos',
        'policy_help_required': 'Si se desactiva, las reglas de campos requeridos no se aplican a este modelo.',
        'policy_info_text': 'Las pol\u00edticas de modelo permiten anular la configuraci\u00f3n global de aplicaci\u00f3n para modelos espec\u00edficos.',
        'policy_info_global': 'Deja los campos en "Desconocido" o vac\u00edos para heredar la configuraci\u00f3n global',
        'policy_info_disable': 'Desactiva la aplicaci\u00f3n para eximir completamente este modelo',
        'policy_info_override': 'Las anulaciones surten efecto inmediatamente',

        # Audit Scan (v4.3.0)
        'audit_scan_title': 'Auditor\u00eda',
        'audit_scan_description': 'Analiza los objetos existentes en la base de datos frente a las reglas de validaci\u00f3n activas. Solo lectura \u2014 no se realizan cambios.',
        'audit_scan_models_with_rules': 'Modelos con reglas activas',
        'audit_scan_no_rules': 'No se encontraron reglas de validaci\u00f3n activas. Crea reglas primero para usar el esc\u00e1ner.',
        'audit_scan_run': 'Iniciar esc\u00e1ner',
        'audit_scan_limit_hint': 'El esc\u00e1ner est\u00e1 limitado a 500 objetos por modelo para evitar tiempos de espera.',
        'audit_scan_results': 'Resultados del esc\u00e1ner',
        'audit_scan_violations': 'violaci\u00f3n/violaciones',
        'audit_scan_errors': 'Errores del esc\u00e1ner',
        'audit_scan_empty': 'No se encontraron violaciones. Todos los objetos existentes cumplen con las reglas actuales.',
        'audit_scan_col_model': 'Modelo',
        'audit_scan_col_object': 'Objeto',
        'audit_scan_col_type': 'Tipo de regla',
        'audit_scan_col_message': 'Mensaje',
    },
}
