...
# Initial values are English; _localize_menu_items() overwrites them at startup
# based on the stored language setting.
_menu_items = (
    PluginMenuItem(
...
def _localize_menu_items():
    """
    Rebuilds _menu_items with translated labels based on the DB language setting.
