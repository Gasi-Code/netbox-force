...
MESSAGES = {
    'de': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} geändert — {changes}',
    ...
    'en': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} changed — {changes}',
    ...
    'es': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} modificado — {changes}',
    ...
    'cs': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} změněno — {changes}',
    ...
    'da': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} ændret — {changes}',
    ...
    'fr': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} modifié — {changes}',
    ...
    'it': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} modificato — {changes}',
    ...
    'ja': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} を変更 — {changes}',
    ...
    'lv': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} mainīts — {changes}',
    ...
    'nl': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} gewijzigd — {changes}',
    ...
    'pl': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} zmieniono — {changes}',
    ...
    'pt': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} alterado — {changes}',
        'auto_changelog_deleted_msg': '{verbose} eliminado: {name}',
    ...
    'ru': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} изменён — {changes}',
    ...
    'tr': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} değiştirildi — {changes}',
    ...
    'uk': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} змінено — {changes}',
    ...
    'zh-hans': {
        ...
        'auto_changelog_updated_msg': '{verbose} {name} 已更改 — {changes}',
